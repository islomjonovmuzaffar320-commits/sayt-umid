    ...
    function bindEvents() {
      ...
      document.addEventListener("click", (e) => {
        ...
        const movementGroupRow = e.target.closest(".movement-group-row");
        if (movementGroupRow && !e.target.closest("button, input, select, a")) {
          openMovementGroupEditModal(movementGroupRow.dataset.movementEditIds);
          return;
        }
